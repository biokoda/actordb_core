...
createcfg(Main,Extra,Sync,QueryTimeout) ->
	createcfg(Main,Extra,Sync,QueryTimeout,bkdcore:node_name()).
createcfg(Main,Extra,Sync,QueryTimeout,Name) ->
	bkdcore:mkmodule(actordb_conf,[{db_path,Main},{paths,[Main|Extra]},{cfgtime,os:timestamp()},
								   {sync,Sync},{query_timeout,QueryTimeout},{node_name,Name}]).
